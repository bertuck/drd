...
class FeatureContext extends RawDrupalContext {
  ...
  {
    \PHPUnit\Framework\Assert::assertFileExists($this->workingDir . DIRECTORY_SEPARATOR . $path);
  }
  ...
  public function fileShouldContain($path, PyStringNode $text)
  {
    ...
    \PHPUnit\Framework\Assert::assertEquals($this->getExpectedOutput($text), $fileContent);
  }
